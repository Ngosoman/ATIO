...
const ROLES = [
  {
    ...
    imageUrl: 'https://source.unsplash.com/1200x800/?policy,meeting,government',
    color: 'bg-blue-600',
    active: true
  },
  {
    ...
    imageUrl: 'https://source.unsplash.com/1200x800/?farmer,agriculture,field',
    color: 'bg-green-600',
    active: true
  },
  {
    ...
    imageUrl: 'https://source.unsplash.com/1200x800/?research,scientist,laboratory',
    color: 'bg-purple-600',
    active: true
  },
  {
    ...
    imageUrl: 'https://source.unsplash.com/1200x800/?entrepreneur,startup,agriculture',
    color: 'bg-orange-600',
    active: true
  },
  {
    ...
    imageUrl: 'https://source.unsplash.com/1200x800/?community,ngo,development',
    color: 'bg-teal-600',
    active: true
  },
  {
    ...
    imageUrl: 'https://source.unsplash.com/1200x800/?youth,students,education',
    color: 'bg-pink-600',
    active: true
  },
  {
    ...
    imageUrl: 'https://source.unsplash.com/1200x800/?community,farmers,local',
    color: 'bg-amber-600',
    active: true
  },
  {
    ...
    imageUrl: 'https://source.unsplash.com/1200x800/?data,servers,datacenter',
    color: 'bg-indigo-600',
    active: true
  }
];
